...
from sqaSentinel import connectx
...
lh.info("Downgrading paramiko to 1.17.0 to execute test_connect unit tests because of the following issue: http://stackoverflow.com/questions/443387/why-does-paramiko-hang-if-you-use-it-while-loading-a-module/450895#450895")


connx = connectx.SshX(test_config['Connect']['IP'],
