...
with open('./config_vars.yaml', 'r') as stream:
    try:
        ...
        lh.info("Downgrading paramiko to 1.17.0 to execute test_ovs unit tests because of the following issue: "
                "http://stackoverflow.com/questions/443387/why-does-paramiko-hang-if-you-use-it-while-loading-a-module/"
                "450895#450895")

        ovx = ovsx.Ovs(test_config['Ovs']['IP'],
